"""
kinetic_energy.py
    Python module that computes the kinetic energy of the wavefunctions given the planewave coefficients.
"""
...
def compute_Tk(wfk_path):
    """
    Computes the kinetic energy of the wavefunction T_nk = 0.5 sum_G |C_nk(G)|^2|k+G|^2 given planewacoefficients
    ...
    k_red = get_kpt_red(wfk_path) # kpoints in reduced coors (nkpt, 3)
